...
export function AdminQuestionFormPage() {
  ...
  return (
    <div className="dashboard-body">
      ...
      {isEdit && question?.aiGenerationRequest && (
        <p className="field-hint" style={{ marginTop: 0 }}>
          Generated by AI: requested topic <strong>{question.aiGenerationRequest.topic}</strong>, difficulty{' '}
          <strong>{question.aiGenerationRequest.difficulty}</strong>, by {question.aiGenerationRequest.requestedBy.name}{' '}
          on {new Date(question.aiGenerationRequest.createdAt).toLocaleString()}. Review the full content below —
          including hidden test cases and the reference solution — before approving.
        </p>
      )}
